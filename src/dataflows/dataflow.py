...
def flow_train(path:str, merge_df:list, scores:pd.Series) -> tuple:
...
def flow_old(merge_df:list, key1:str, key2:str, rfm_range:int, rfm_vars:list) -> pd.DataFrame:
...
def flow_new(merge_df:list, model_path:str) -> pd.DataFrame:
